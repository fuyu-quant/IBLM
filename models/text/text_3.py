...
def predict(x):
    ...
    for index, row in df.iterrows():
        ...
        positive_words = ['good', 'great', 'excellent', 'amazing', 'wonderful', 'love', 'best', 'favorite', 'beautiful', 'enjoy']
        negative_words = ['bad', 'terrible', 'awful', 'horrible', 'worst', 'hate', 'boring', 'disappointing', 'ugly', 'annoying']
