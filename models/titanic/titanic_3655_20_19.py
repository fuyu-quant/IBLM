Here is a simple Python code that predicts the probability of "target" being 1 based on the given data. This code uses a simple rule-based approach to make predictions. It checks if the passenger is a female, if the passenger is in the first class, and if the passenger is an adult. If all these conditions are met, it predicts a high probability of survival (0.9). Otherwise, it predicts a low probability of survival (0.1). 
